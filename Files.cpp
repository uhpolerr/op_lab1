...
//ôóíêö³ÿ äëÿ çàïèòó â êîðèñòóâà÷à ³ìåí³ ôàéëó 
string get_filename() {
    string filename;
    bool valid = false;
    string invalidChars = "\\/:;*?! .,\"<>|";
    ...
    cin >> filename;
        ...
        if (filename.length() > 20) {
            cout << "Íåâ³ðíà íàçâà ôàéëó. Íàçâà ôàéëó ïîâèííà áóòè íå á³ëüøå 20 ñèìâîë³â." << endl;
        }
        else {
            ...
            if (containsInvalidChars) {
                cout << "Íàçâà ôàéëó íå ìîæå ì³ñòèòè íàñòóïí³ ñèìâîëè " << invalidChars << endl;
...
char* get_filename1() {
    ...
    while (!valid) {
        ...
        if (strlen(filename) > max_filename_length - 1) {
            cerr << "Íåâ³ðíà íàçâà ôàéëó. Íàçâà ôàéëó ïîâèííà áóòè íå á³ëüøå 20 ñèìâîë³â." << endl;
        }
        else {
            bool containsInvalidChars = false;
            ...
            if (containsInvalidChars) {
                cout << "Íàçâà ôàéëó íå ìîæå ì³ñòèòè íàñòóïí³ ñèìâîëè \\/:;*?! .,\"<>|" << endl;
            }
            else {
                valid = true;
            }
...
//ôóíêö³ÿ äëÿ ñòâîðåííÿ íîâîãî ôàéëó
void create_file(const string& filename) {
    ofstream file(filename);

    cout << "Ñòâîðåíî íîâèé ôàéë " << filename << endl;
    cout << endl;

    if (!file.is_open()) {
        cout << "Íå âäàëîñÿ ñòâîðèòè ôàéë " << filename << endl;
    }
...
//ôóíêö³ÿ äëÿ çàïèñó òåêñòó â ôàéë
void text_to_file(string& filename) {
    ...
    if (!file.is_open()) {
        cout << "Íå âäàëîñÿ â³äêðèòè ôàéë " << filename << endl;
        return;
    }

    cout << "-------------------------------------------------------"<< endl;
    cout << "Ââåä³òü òåêñò, ÿêèé áàæàºòå çàïèñàòè ó ôàéë äëÿ ïîäàëüøîãî øèôðóâàííÿ " << filename << endl;
    cout << "Íàòèñí³òü 1, ùîá çàâåðøèòè çàïèñ."<< endl;
    cout << endl;
    ...
    while (getline(cin, line)) {
        ...
        if (curr_size > max_size) {
            cout << "Ïîìèëêà ââîäó. Ðîçì³ð ôàéëó íå ìàº ïåðåâèùóâàòè 10 ÌÂ" << endl;
            file.close();
    ...
    cout << endl;
    cout << "Çàïèñ çàâåðøåíî." << endl;
    cout << "-------------------------------------------------------" << endl;
    cout << endl;

    cout << endl;
    cout << "-------------------------------------------------------" << endl;
    cout << "Âì³ñò ñòâîðåíîãî ôàéëó:" << endl;
...
void text_to_file(char* filename) {
    ...
    while (scanf(" %[^\n]%*c", line)) {
        if (line[0] == '1' && strlen(line) == 1) {
            ...
            cout << "Ðÿäîê ìàº áóòè ìåíøå 4192 ñèìâîë³â. Ñïðîáóéòå ùå ðàç." << endl;
            continue;
        }
        fprintf(fp, "%s \n", line);
    }
...
//ôóíêö³ÿ äëÿ â³äêðèòòÿ ôàéëó òà â³äîáðàæåííÿ éîãî çì³ñòó
...
//ôóíêö³ÿ äëÿ ââåäåííÿ Ê
int enter_k() {
    int k;
    bool valid = false;

    while (!valid) {
        cout << "Ââåä³òü Ê (ê³ëüê³ñòü åëåìåíò³â äëÿ ðîçáèòòÿ íà ãðóïè)" << endl;
        cin >> k;
        if (k > 20) {
            cout << "Ê ìàº áóòè íå á³ëüøå 20" << endl;
        }
        else {
            valid = true;
        }
...
//ôóíêö³ÿ äëÿ çâîðîòíîãî çàïèñó ñèìâîë³â â ðÿäêó
...
//ôóíêö³ÿ äëÿ øèôðóâàííÿ òåêñòó â ðÿäêàõ
...
//ôóíêö³ÿ äëÿ çàïèñó â ôàéë øèôðóâàííÿ òåêñòó â ðÿäêàõ
void encryption(string& filename, int k) {
    ...
    cout << endl;
    //cout << "Âì³ñò çàøèôðîâàíîãî ôàéëó:" << endl;
...
//ôóíêö³ÿ äëÿ â³äáîðó íåïàðíèõ ðÿäê³â
void choose_line() {
...
//ôóíêö³ÿ äëÿ ïåðåâ³ðêè ëàòèíñüêèõ ñèìâîë³â
...
//ôóíêö³ÿ äëÿ âèäàëåííÿ ëàòèíñüêèõ ñë³â
void remove_latin_words() {
    ...
    cout << "-------------------------------------------------------" << endl;
    cout << "Âì³ñò çàøèôðîâàíîãî íîâîãî ôàéëó:" << endl;
    cout << endl;
}
